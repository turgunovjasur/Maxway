...
def main_dashboard(request):
    categories = Category.objects.all()  # barcha Category larni olish uchun ishlatiladi.
    products = Product.objects.all()     # barcha Product larni olish uchun ishlatiladi.
    customers = Customer.objects.all()   # barcha Customer larni olish uchun ishlatiladi.
    orders = Order.objects.all()         # barcha Order larni olish uchun ishlatiladi.
    categories_products = []             # bo'sh ro'yxat (list) yaratish
